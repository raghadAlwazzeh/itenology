...
@section('main')
    ...
    <div class="container">
        <div class="content-wrapper">
            <section class="intro-wrapper">
                <div class="row">
                    <div class="col-lg-6 col-md-8">
                        ...
                        <p class="wow fadeInDown">Established in 2001, Itenology Corporation offers full Transportation
                            Engineering, Transportation Planning, Construction Inspection and Management, GIS and IT
                            application developments to Government and private sectors.</p>

                        <h3 class="wow fadeInDown">Engineering Services</h3>
                        <p class="wow fadeInDown">Itenology offers extensive knowledge and expertise in traffic engineering
                            including data collection, studies and analysis, travel forecasting, demand modeling, and
                            operational and capacity analyses.
                            <br>
                            Itenology Corporation employs Professional Engineers who are registered in multiple states and
                            who possess more than 60 years of experience in the inspection of bridges and ancillary
                            structures.
                            <br>
                            Itenology Team Leaders are NBIS certified and have performed hands-on inspection on over 1000
                            bridges and more than 5000 ancillary structures including sign structures, signal structures,
                            and high-mast lighting poles. Itenology also has professional engineers who have performed
                            construction inspection on roadway infrastructures, new bridge construction, caisson
                            drilling/pouring, and rehab of historic structures; and prepared training material and
                            certificates for the inspection of the installation of sign structures.
                        </p>
                        <h3 class="wow fadeInDown">Information Technology</h3>
                        <p class="wow fadeInDown">Itenology provides its clients with state-of-the-art technology services
                            and innovative solutions that aid them in solving their business challenges.
                            <br>
                            Through the use of web, desktop and mobile technologies, we make it possible for our clients to
                            access and visualize their data spatially thus enabling them to raise and respond to questions
                            that would otherwise not be possible.
                            <br>
                            Itenology utilizes the latest technology and is expert in Dot NET Application Development,
                            Mobile Application Development, SharePoint Solutions, Enterprise Database Applications, Oracle
                            Database and SQL Database Management and Development.
                        </p>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-md-pull-6 work-col">
                                    <div class="handover-project">
                                        ...
                                        <a class="btn btn-primary" href="/project/{{ $projects[0]->id }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-md-pull-6 work-col">
                                        <div class="handover-project">
                                            ...
                                            <a class="btn btn-primary" href="/project/{{ $projects[$i]->id }}"
                                                role="button">Read More</a>
                                        </div><!-- /.handover-project -->
                                    </div><!-- /.col-md-6 -->
                                </div><!-- /.row -->
                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-7 wow fadeInLeft">
                                    <div class="client-testimonial">
                                        <p>Your efficiency is just impressive! Thanks a lot for you and your team's hard
                                            work.</p>
                                        <span class="client-name">JIANYANG (JAY) ZHENG</span>, <span
                                            class="client-org">STATE HIGHWAY ADMINISTRATION</span>
                                    </div>
                                </div><!-- /.col-md-8 -->
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-7">
                                    <div class="client-testimonial">
                                        ...
                                        <span class="client-name">DONNA BUSCEMI</span>, <span class="client-org">STATE
                                            HIGHWAY ADMINISTRATION</span>
                                    </div>
                                </div><!-- /.col-md-8 -->
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-md-8 col-sm-7">
                                    <div class="client-testimonial">
                                        <p>You and your team did a great job making sure everything stays consistent. Great
                                            working with you, as always.</p>
                                        <span class="client-name">JON SCHMIDT</span>, <span class="client-org">STATE
                                            HIGHWAY ADMINISTRATION</span>
                                    </div>
                                </div><!-- /.col-md-8 -->
                                <div class="col-md-4 col-sm-5">
            ...
            <section class="Mdot-Section">
                <h2 class="section-title wow fadeInDown">MDOT Certified MBE/DBE/SBE </h2>
                <div class="content">
                    <div class="MDOT-element">
                        <h5>NAICS Code: 541512</h5>
                        <p>Computer Systems Design Services</p>
                    </div>
                    <div class="MDOT-element">
                        <h5>NAICS Code: 518210</h5>
                        <p>Data Processing, Hosting, and Related Services</p>
                    </div>
                    <div class="MDOT-element">
                        <h5>NAICS Code: 541330 </h5>
